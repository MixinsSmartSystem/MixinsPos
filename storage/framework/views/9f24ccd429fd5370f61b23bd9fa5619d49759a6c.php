        ...
        <ul class="dock-container">
            <li>
                <router-link to="/home">
                    ...
                    <img class="ico" src="<?php echo e(asset('backend/img/footer/home.png')); ?>" alt="">
                </router-link>
            </li>
            <li>
                <router-link to="/report">
                    <div class="name">الرئيسية</div>
                    <img class="ico" src="<?php echo e(asset('backend/img/reports/report.png')); ?>" alt="">
                </router-link>
            </li>
        </ul>
    </div>
...
<!-- Topbar -->
<?php /**PATH F:\AppServ\www\Mixinis\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>