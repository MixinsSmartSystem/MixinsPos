...
class TypeRequest extends FormRequest
{
    ...
    {
        return [
            'type_name_ar'=>'required|unique:types',
            'type_sill_price'=>'required',
            'type_barcode'=>'required|unique:types',
    ...
    public function messages()
    {
        return [
            ...
            'type_barcode.required'=>'يجب ادخال باركود الصنف ',
            'type_barcode.unique'=>'هناك صنف أخر له نفس باركود',
