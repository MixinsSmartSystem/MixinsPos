...
class MixinsPurchaseBills extends Model
{
    ...
    protected $fillable=['purchase_bill_no','supplier_name',
        'bill_serial','bill_sum','bill_discount','bill_extra','bill_vat_val','bill_total','bill_paid_val','bill_remain_val','bill_paid_type','bill_date','user_id','bill_notes','deleted_bill','mixins_store','purchase_img','mixins_purchase_bills_no'];
