      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body">
            <div class="card">
              <div
                ...
                "
              >
                <h6 class="m-0 font-weight-bold text-primary">توريد نقدية</h6>
              </div>
              <div class="card-body">
                  ...
                  <div class="card-body">
                    ...
                    <div class="input-group mb-3">
                      <div class="input-group-append">
                        <span class="input-group-text">كود العميل</span>
                      </div>
                      <input
            ...
            <div
              aria-hidden="true"
              aria-labelledby="exampleModalLabel"
              :class="showPay ? 'modal fade d-block show' : 'modal fade'"
              role="dialog"
              tabindex="-1"
            >
              <div
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" @click="payMoney()">
              حفظ
            </button>
          </div>
        </div>
