                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                    ...
                    <div class="modal-content m-auto" style="min-width: 850px;">
                        <div class="modal-header">
                            <h5 i class="modal-title">{{ bill.bill_total }}</h5>
                ...
                <form class="w-100 " direction="rtl" @submit.prevent="saveBill">
                    <table class="table-bordered text-lighten-1 text-center font-weight-bold">
                        ...
                        <tr>
                            ...
                            <td style="width:10%"><select id="inputState" v-model="form.pay" @change="calcTotal()"
                                        ...
                                        <table style="overflow-x:auto"
                                            ...
                                            >
                                                ...
                                                <td>
                                                    ...
                                                    <button v-else class="btn mx-2 btn-warning"
                                                    ...
                                                    <button class="btn mx-2 btn-success" :disabled="product.has_Offer"
                                                ...
                                                <td>
                                                    <input class="btn text-bold"
                                                           ...
                                                           v-model="product.type_sill_price">
                                                </td>
                                                <td v-show="!$root.$data.mixins.bill_with_main_type">
                                                    <input class="btn text-bold"
                                                           ...
                                                           @keyup="onChangeTypeCost(product)"
                                                           v-model="product.type_discount_value">
                                                </td>
                                                <td v-show="!$root.$data.mixins.bill_with_main_type">
                                                    <input class="btn text-bold"
                                                           style="width: 100px"
                                                           ...
                                                           @keyup="onChangeTypeCost(product)"
                                                           v-model="product.type_discount_percent">
                                                </td>
                                                <td>
                                            ...
                                            <tbody v-else>
                                            <tr class=" w-100">
                                                <td colspan="7" class="m-auto font-weight-light">لا توجد أصناف</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
...
export default {
    ...
    methods: {
        ...
        calcIfCustomerHasDiscount() {
            ...
            if (
                moment(this.$root.$data.mixins.offer_start_date).isBefore(current) &&
                moment(this.$root.$data.mixins.offer_end_date).isAfter(current)
            ) {
                if (this.$root.$data.mixins.offer_percenet > 0) {
                    this.isPercentDiscount = true;
                    this.form.discount = this.$root.$data.mixins.offer_percenet;
                    return;
                }
                if (this.$root.$data.mixins.offer_value > 0) {
                    this.form.discount = this.$root.$data.mixins.offer_value;
                    return;
                }
            }
        },
        ...
        async calcTotal() {
            if (this.$root.$data.mixins.active_offer) {
