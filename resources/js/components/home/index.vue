    ...
    <div>
        ...
        "
                ...
                >
                        ...
                        >
                            <input
                                ...
                                type="search"
                            />
                            <button class="btn btn-sm btn-info" @click="findTypeByLike()">
                ...
                <form class="w-100" direction="rtl" @submit.prevent="saveBill">
                    ...
                    >
                        ...
                        <tr>
                            ...
                            <td style="width: 10%">
                                <button
                                    :disabled="form.total <= 0 || cart.length <= 0"
                        ...
                        <tr>
                            ...
                            <td v-show="$root.$data.roles.includes(12)" style="width: 10%">
                                الخصم:{{ this.isPercentDiscount ? "%" : "" }}
                            </td>
            ...
            <div class="row mb-3 newBill">
                <div
                    :class="
            mixins.bill_with_main_type ? 'col-md-6' : 'col-md-12 float-right'
          "
                >
                        ...
                        <div style="min-height: 50vh">
                                    ...
                                    <div id="body" class="col-sm-12">
                                        ...
                                        >
                                            ...
                                            <tr>
                                                ...
                                                <th style="width: 10%">السعر</th>
                                                <th
                                                    v-show="!$root.$data.mixins.bill_with_main_type"
                                                    style="width: 10%"
                                                >
                                                    ق.الخصم
                                                </th>
                            ...
                            "
                              ...
                              "
                                            ...
                                            <tbody v-else>
                                            <tr class="w-100">
                                                <td class="m-auto font-weight-light" colspan="7">
                                                    لا توجد أصناف
                                                </td>
                                            </tr>
                                            </tbody>
                ...
                <div v-if="mixins.bill_with_main_type" class="col-md-6">
                    ...
                    >
                                ...
                                >
                                    <div class="card text-center">
                                        <img
                                            ...
                                            :src="
                        product.type_icon != null && product.type_icon != ''
                          ? product.type_icon
                      ...
                      "
                          ...
                          badge badge-info
                        "
                                            >{{ Number(product.type_sill_price).toFixed(2) }}</b
                                            >
                            ...
                            <div class="col-lg-12 mb-4">
                                <div class="table-responsive w-100">
                                    ...
                                    <table class="table align-items-center">
                                        <thead>
                                        <tr>
                                            <th style="width: 50%">كود العميل</th>
                                            <th style="width: 30%">اسم العميل</th>
                                            <th style="width: 10%">هاتف العميل</th>
                                            <th style="width: 10%">رصيد العميل</th>
...
export default {
    ...
    methods: {
                        ...
                        if (type.main_type != null) {
                            if (product.type_count === type.main_type_count) {
                                ...
                                offer.type_sill_price =
                                    offer.type_sill_price -
                                    (offer.type_sill_price * type.offer_discount_percent) /
                                    100.0;
                                offer.type_count = 1;
        ...
        calcIfCustomerHasDiscount() {
            if (this.cart.length > 0 && this.customer != null)
