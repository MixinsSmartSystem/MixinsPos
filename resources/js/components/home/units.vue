<template>
    <div>
        ...
        <div v-show="!loading">
            <!--        Search -->
            <div :class="showSearchTypeModal?'modal fade show d-block modaldrg':'modal fade modaldrg'" aria-hidden="true"
                ...
                <form class="w-100 " direction="rtl" @submit.prevent="saveBill">
                    <table class="table-bordered text-lighten-1 text-center font-weight-bold">
                        ...
                        <tr>
                            ...
                            <td style="width:10%"><select id="inputState" v-model="form.pay" class="form-control form-control-sm float-left text-center"
                                                          @change="calcTotal()">
                                                ...
                                                <td>
                                                    <select v-model="product.sell_unit" class="form-control-sm"
                                                        ...
                                                        <option v-for="(unit,index) in product.units"
                                                                :key="index" :selected="unit.type_unit_id===product.sell_unit"
