    ...
    <div>
        ...
        <div v-show="!loading">
            ...
            <div class="card-header " style="overflow-x:auto ">
                ...
                <div>
                    <span> المبيعات</span>
                    <select v-model="saleType" class="form-control-sm text-center"
                            @change="calcSum()">
                        <option v-for="(sale,index) in salesType" :key="index" :value="sale">
                            {{ sale.sill_type_name }}
                        </option>
                    </select>
            ...
            <div class="row mb-3 newBill">
                <div :class="mixins.bill_with_main_type?'col-md-6':'col-md-12 float-right'">
                    ...
                    <div class="selected text-center w-100">
                        ...
                        <div v-if="cart.length>0" style="min-height:50vh;">
                                    ...
                                    <div id="body" class="col-sm-12 ">
                                        <table
                                            ...
                                            <tr>
                                                ...
                                                <th v-show="mixins.use_type_uints" style="width: 10%">الوحدة</th>
                                            ...
                                            >
                                                ...
                                                <td v-show="mixins.use_type_uints">
    ...
    methods: {
        ...
        async calcSum() {
            ...
            if (this.saleType !== null) {
                let discount = this.form.sum * (this.saleType.sill_type_discount / 100);
                this.form.sum = this.form.sum - Number(discount);
            }
